...
public class WitchHouseFeature extends Utility.ModStructureFeature {
    public static ResourceLocation ID = new ResourceLocation(MODID + ":witch-house");
    ...
    public static final StructureFeature<JigsawConfiguration> DEFAULT =
            new WitchHouseFeature(JigsawConfiguration.CODEC);
    static {
    ...
    public WitchHouseFeature(Codec<JigsawConfiguration> codec) {
        super(codec, ID);
    }
    ...
    public @Nullable Utility.PlacementData shouldStartAt(ChunkGenerator generator, ChunkPos pos,
        ...
        BlockPos structurePos = TestStructureMask(generator, world,
                generator.getBaseHeight(pos.getMinBlockX(), pos.getMinBlockZ(), Heightmap.Types.WORLD_SURFACE_WG, world) - 25,
                generator.getBaseHeight(pos.getMinBlockX(), pos.getMinBlockZ(), Heightmap.Types.WORLD_SURFACE_WG, world) - 5, 1, rotation, pos);
