...
public class AlchemistLabFeature extends Utility.ModStructureFeature {
    public static ResourceLocation ID = new ResourceLocation(MODID + ":alchemist-lab");
    ...
    public AlchemistLabFeature(Codec<JigsawConfiguration> codec) {
        super(codec, ID);
    }
    ...
    public @Nullable Utility.PlacementData shouldStartAt(ChunkGenerator generator, ChunkPos pos,
        ...
        BlockPos structurePos = TestStructureMask(generator, world, 80, 35, -1,
                rotation, pos);
