...
public class AlchemistLabFeature extends Utility.ModStructureFeature {
    public static Identifier ID = new Identifier(MODID + ":alchemist-lab");
    ...
    public static StructurePool STRUCTURE_POOLS = StructurePools.register(
            new StructurePool(
                    ...
                    ImmutableList.of(
                            ...
                            Pair.of(StructurePoolElement.ofProcessedSingle(MODID + ":alchemist-lab",
                                    PROCESSOR_LIST), 1)
                    ),
    ...
    public static final StructureFeature<StructurePoolFeatureConfig> DEFAULT =
            new AlchemistLabFeature(StructurePoolFeatureConfig.CODEC);
    ...
    public @Nullable Utility.PlacementData shouldStartAt(DynamicRegistryManager dynamicRegistryManager,
        ...
        for (BlockRotation rotation : BlockRotation.randomRotationOrder(random)) {
            ...
            for (int y = generator.getHeightOnGround(x, z, Heightmap.Type.WORLD_SURFACE_WG, world) - 5;
                ...
                if (!Utility.boxBlockSampleCompare(blockstate -> blockstate.isAir(), generator, world,
                        new BlockPos(x + (0 * xMod), y + 5, z + (0 * zMod)),
                        new BlockPos(x + (9 * xMod), y + 18, z + (9 * zMod)))) continue;
